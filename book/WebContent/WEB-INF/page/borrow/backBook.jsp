...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="2">
        ...
        <tr>
            <td colspan="10"  bgcolor="6f8ac4" align="center" height="38"><FONT COLOR="#FFFFFF" >图书归还</FONT> &nbsp; </td>
          </tr>
       ...
       <tr>
		  ...
		  <td width="10%" bgcolor="6f8ac4"><div align="center"><font color="#FFFFFF">归还</font></div></td>
       </tr>
<!---------------------------LOOP START------------------------------>
    ...
    <tr>
	  ...
	  <td bgcolor="f5f5f5"> <div align="center"><input type="button" value="归还" onclick="JavaScript:actionEvent('backBook','${borrow.id}')"/></div></td>
	</tr>
   </c:forEach>
    </table></td>
    </tr>
