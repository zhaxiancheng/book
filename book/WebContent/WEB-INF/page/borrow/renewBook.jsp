...
function actionEvent(methodName ,id){
	...
	form.action='<html:rewrite action="/control/book/back"/>?method='+methodName+'&id='+id;
	form.submit();
...
<body><br>
<html:form action="/control/book/back" method="post">
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#333333">
  ...
  <tr>
    ...
    <tr style="height: 50px; background:#FFFFCC;">
        ...
        <td width="38%" ><input type="button" value="查询" onclick="JavaScript:actionEvent('renewborrowBook','')"/>&nbsp;</td>
    </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="2">
        ...
        <tr>
            <td colspan="10"  bgcolor="6f8ac4" align="center" height="38"><FONT COLOR="#FFFFFF" >图书续借</FONT> &nbsp; </td>
          </tr>
       ...
       <tr>
		  ...
		  <td width="10%" bgcolor="6f8ac4"><div align="center"><font color="#FFFFFF">续借</font></div></td>
       </tr>
<!---------------------------LOOP START------------------------------>
    ...
    <tr>
	  ...
	  <td bgcolor="f5f5f5"> <div align="center"><input type="button" value="续借" onclick="JavaScript:actionEvent('renewBook','${borrow.id}')"/></div></td>
	</tr>
   </c:forEach>
    </table></td>
    </tr>
