...
<table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="60%"> <html:text property="librarycard" size="35" maxlength="30"/><font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="40%"> <div align="right">读者姓名 ：</div></td>
      <td width="60%"> <html:text property="username" size="35" maxlength="30"/><font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
