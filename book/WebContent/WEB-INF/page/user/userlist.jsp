...
<!--
	...
	function user_action(methodName){
		var form = document.forms[0];
		form.action='<html:rewrite action="/control/user/manage"/>?method='+ methodName;
		form.submit();
...
<input name="method" type="hidden">
  <table width="98%" border="0" cellspacing="1" cellpadding="2" align="center">
    ...
    <tr>
      <td width="20%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">借阅卡号</font></div></td>
      <td width="15%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">用户名</font></div></td>
      <td width="15%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">电子邮箱</font></div></td>
	  <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">性别</font></div></td>
	  <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">罚金</font></div></td>
...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      <td bgcolor="f5f5f5"> <div align="center"><input type="checkbox" name="usernames" value="${entry.librarycard}">${entry.librarycard}</div></td>
	  ...
	  <td bgcolor="f5f5f5"> <div align="center"> ${entry.fine }</div></td>
...
<input type="button" value=" 修改读者信息" class="frm_btn" onclick="javascript:_action('updateUI')">&nbsp;&nbsp;
<input type="button" value=" 添加读者" class="frm_btn" onclick="javascript:user_action('addUI')">&nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
