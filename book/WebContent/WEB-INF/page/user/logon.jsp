			...
			<td align="center"><table width="80%" border="0" align="center" cellpadding="10" cellspacing="0">
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
								  <td width="40%" align="right" class="c5"><strong>借阅证号：</strong></td>
								  <td width="27%"> <input name="librarycard" id="librarycard" type="text" size="20" maxlength="20" /></td>
								  <td align="left">&nbsp;</td>
						  </tr>
								<tr>
								...
								<tr>
									<td align="right" class="c5"><strong>密码：</strong></td>
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<td width="21%" align="right">&nbsp;</td>
									<td width="58%" align="left" valign="middle">如果你还未激活，<span style="font-size:14px"><a href='<html:rewrite action="/user/reg"/>?method=regUI&directUrl=${param.directUrl }' class="ablue2">请您激活</a>！</span></td>
								  <td width="21%" align="right">&nbsp;</td>
								</tr>
							</table>
                       </td>
