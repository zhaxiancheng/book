...
<HEAD><TITLE>忘记密码:河南文理学院图书馆</TITLE>
...
function validateForm(form){
	...
	if(librarycard==null || trim(librarycard)==""){
		alert("借阅卡号不能为空");
		form.librarycard.focus();
		return false;
	}
//	return true;
}
                        ...
                        <TABLE cellSpacing=4 cellPadding=4 width="100%" border=0>
                          ...
                          <TR align=left>
                            <TD colSpan=3><SPAN 
                              ...
                              class="font14b">请输入您的借阅卡号，点击继续</STRONG></TD></TR>
                          <TR align=left>
                            <TD class="font12b" align="right" width="27%">借阅卡号</TD>
                            <TD width="39%"><input maxLength="20" size="30" name="librarycard" ></TD>
