...
function exitsystem(){
	if (confirm('您确定要退出系统吗？'))
	  window.parent.location="<html:rewrite action='/employee/logout.do'/>"; 
}
</SCRIPT>
      ...
      bgColor=#6386de border=0>
        ...
        <TR height=38>
          ...
          <TD vAlign=center align=right>
			<A onmouseover="MM_nbGroup('over','OAHeader_r1_c5','/images/OAHeader_r1_c5_f2.gif','/image/OAHeader_r1_c5_f3.gif',1);" 
