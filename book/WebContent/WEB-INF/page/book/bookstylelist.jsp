...
<html:form action="/control/book/style/manage" method="post">
<input type="hidden" name="method" value="">
<html:hidden property="bookid"/>
  <table width="98%" border="0" cellspacing="1" cellpadding="2" align="center">
    <tr>
      <td width="7%" nowrap bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">选择</font></div></td>
      <td width="8%" nowrap bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">修改</font></div></td>
      <td width="15%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">样式名称</font></div></td>
     <td width="15%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">出版社</font></div></td>
     <td width="15%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">版次</font></div></td>
      <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">在架状态</font></div></td>
	  <td width="30%" nowrap bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">图书图片</font></div></td>
    </tr>
<!---------------------------LOOP START------------------------------>
<c:forEach items="${styles}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="<html:rewrite action="/control/book/style/manage"/>?method=editUI&bookstyleid=${entry.styleid}">
	  <img src="/images/edit.gif" width="15" height="16" border="0"></a></div></td>
      <td bgcolor="f5f5f5"> <div align="center">${entry.name}</div></td>
      <td bgcolor="f5f5f5"> <div align="center">${entry.ISBN}</div></td>
      <td bgcolor="f5f5f5"> <div align="center">${entry.revision}</div></td>
      <td bgcolor="f5f5f5"> <div align="center"><c:if test="${entry.visible}">在架</c:if><c:if test="${!entry.visible}">不在架</c:if></div></td>
          ...
          <tr> 
            <td width="8%"><INPUT TYPE="checkbox" <c:if test="${fn:length(styles)<1}">disabled="disabled"</c:if>
             NAME="all" onclick="javascript:allselect(this, this.form.stylesids)">全选</td>
              <td width="85%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='<html:rewrite action="/control/book/style/manage"/>?method=addUI&bookid=${param.bookid}'" value="添加图书样式"> &nbsp;&nbsp;
