...
function verifyForm(objForm){
	...
	new Formfield("price", "图书价格"),new Formfield("barcode", "图书条形码"),
	new Formfield("ISBN", "图书出版社"),new Formfield("revision", "图书版次"),
	new Formfield("stylename", "图书的样式"),new Formfield("imagefile", "图书图片"));
...
<html:hidden property="typeid"/>
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"> 
      <td colspan="2" ><font color="#FFFFFF">添加图书：</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">图书样式 ：</div></td>
      <td width="75%"> 名称：<input name="stylename" type="text" size="20">
      <br>图片：<input type="file" name="imagefile" size="30">
      <br>出版社(ISBN)：<input name="ISBN" type="text" size="10">
      <br>版次：<input type="text" name="revision" size="30"></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
